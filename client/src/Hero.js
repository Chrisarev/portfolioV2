...
const Hero = () => {
    ...
    return (
        ...
        <div className={styles.panel}>
            ...
            <div className={styles.header}>I'm Christian Lizasuain.</div>
            ...
            <div className={styles.circle} id="circle">
                <svg onClick={handleNav} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="300px" height="300px" viewBox="0 0 300 300">
                    <defs>
